...
//--GPIO_DDR_1bit(PORTx,n,ddr)--//
#define SCL_OUT   Gpio_init(PORT_C,14,1,1)      //SCL-PA0设置为输出端口
#define SDA_OUT   Gpio_init(PORT_C,17,1,0)      //SDA-PA1设置为输出端口
#define SDA_IN    Gpio_init(PORT_C,17,0,0)      //SDA-PA1设置为输入端口
